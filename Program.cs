...
namespace MatrixCalculator
{
    public class Matrix
    {
        ...
        public static Matrix operator +(Matrix MatrixA, Matrix MatrixB)
        {
            if (MatrixA.Size != MatrixB.Size)
                throw new ArgumentException("матрицы не одного размера!");
        ...
        public static bool operator ==(Matrix MatrixA, Matrix MatrixB)
        {
            ...
            for (int ColumnCounter = 0; ColumnCounter < MatrixA.Size; ++ColumnCounter)
            {
                ...
                MatrixA.Size; ++RowCounter)
                {
                    if (MatrixA[ColumnCounter, RowCounter] !=
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // как можно использовать операторы и методы
            Console.WriteLine($"матрица A + мaтрица B = \n{MatrixA + MatrixB}");
            Console.WriteLine($"мaтрица A * мaтрица B = \n{MatrixA * MatrixB}");
            Console.WriteLine($"мaтрица A > мaтрица B: {MatrixA > MatrixB}");
            ...
            var c = MatrixA.Clone();
            Console.WriteLine($"C = \n{c}");
            Console.WriteLine($"мaтрица A == C: {MatrixA == c}");
    ...
    {
        public InvalidMatrixSizeException(int size) : base($"нельзя использовать такой размер матрицы: {size}")
        {
        }
    }
